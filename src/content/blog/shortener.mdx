...
Of course I deployed it to [Railway](https://railway.app). I may be biased, but
it deploys seamlessly with Redis hosted in the same place.

You can also deploy your own 👇

[![Deploy on
Railway](https://railway.app/button.svg)](https://railway.app/new/template?template=https%3A%2F%2Fgithub.com%2Fcoffee-cup%2Fshortener&envs=BASE_URL&BASE_URLDesc=URL+that+the+site+is+hosted+at)
